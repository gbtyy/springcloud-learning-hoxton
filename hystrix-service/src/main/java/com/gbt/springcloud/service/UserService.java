...
public class UserService {
    ...
    public List<User> listUsersByIds(){
        ParameterizedTypeReference<Result<List<User>>> typeRef = new ParameterizedTypeReference<Result<List<User>>>() {
        };
        Result<List<User>> result = restTemplate.exchange(userServiceUrl + "/user/listUsersByIds?ids=1,2",
    ...
    public Result getUserCache(@CacheKey("id") Long id) {
